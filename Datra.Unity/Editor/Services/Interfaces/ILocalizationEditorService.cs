...
{
    /// <summary>
    /// Service interface for localization editing operations.
    /// Wraps LocalizationContext with editor-specific functionality.
    /// </summary>
    public interface ILocalizationEditorService
    {
        ...
        /// </summary>
        string GetTranslation(string key, LanguageCode language);

        /// <summary>
        /// Set translation for a key
        /// </summary>
        void SetTranslation(string key, string value, LanguageCode language);
        ...
        /// </summary>
        event Action<string, LanguageCode> OnTranslationChanged;
